...
пы-сы: 
- ВАЖНО: ЕСЛИ ВЫ ЗАПУСКАЕТЕ СКРИПТ НА СЕБЕ, СНАЧАЛА ОТКЛЮЧИТЕ SOCKS5, ПРОКСИ, PAC-СКРИПТЫ И ДРУГИЕ МЕТОДЫ ОБХОДА БЛОКИРОВОК — КАК В СИСТЕМЕ, ТАК И В БРАУЗЕРЕ. ИНАЧЕ ПРОВЕРКА СТРАТЕГИЙ НЕ БУДЕТ РАБОТАТЬ КОРРЕКТНО.
...
- При проверке стратегий: чем больше ссылок, тем дольше ждать первый и последующие результаты... (Терпение в районе 1 минуты).
